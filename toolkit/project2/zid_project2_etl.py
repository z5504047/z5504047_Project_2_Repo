...
# ----------------------------------------------------------------------------
def daily_return_cal(prc):# 计算每一日与前一日收益率之比-1
...
# ----------------------------------------------------------------------------
def monthly_return_cal(prc):# 计算并返回一个个股的月度收益率Pandas序列
...
def aj_ret_dict(tickers, start, end):
    ...
    # 创建返回字典，其中包含日收益率和月收益率的DataFrame
    ret_dict = {
